...
select * from tribo.usuario_perfil up where id_usuario = 1
delete from tribo.usuario_perfil up2 where id_usuario = 1 and id_perfil = 2
...
(nome, descricao, situacao, data_criacao)
VALUES('Marcenaria', 'Marcenaria', 0, '12/31/2020 00:00');
...
VALUES('Marcenaria', 'Móveis, reforma de móveis', 0, '01/02/2021 10:00', 2, 1, '', 0);
